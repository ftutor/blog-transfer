...
public class DeserializeOperationTest {
    ...
    @Test
    public void testDeserializeIncludeMore() {

        person = DeserializeOperation.DeserializeIncludeMore(person);

        LOG.info("after deserialize:" + person);
        LOG.info("ADDRESS:" + person.getAddresses());
